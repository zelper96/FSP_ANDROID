...
import com.nexgrid_fsp.myapplication.sharinglive.ScreenImageDataCall;
import com.nexgrid_fsp.myapplication.sharinglive.ScreenImageUiSet;
...
import static com.nexgrid_fsp.myapplication.sharinglive.ScreenImageDataCall.beforeScreenString;



public class Thumbnail_View_H extends BeginFSPActivity {
    ...
    private Timer timetab = new Timer();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.activity_thumbnail_default_h);
...
//            Spawn(Spawn_url);
    ...
    private void TimeTab()
    {
        view_top  = findViewById(R.id.view_top);
        titlename = findViewById(R.id.title_name);
        time_date = findViewById(R.id.time_data);

        TimerTask todate = new TimerTask()
        {
            @Override
            public void run()
            {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        view_top.setBackgroundColor(Color.parseColor(mainC));

                        //장례식장 이름
//                        titlename.setTextColor(Color.parseColor(bright_text_Color));
                        titlename.setText(title_name);
                        //현제 시간
//                        time_date.setTextColor(Color.parseColor(bright_text_Color));
                        time_date.setText(to_date_time);

                    }
                });
            }
        };
        timetab.schedule(todate,0,4000);
    ...
    private void reqRoomList(final String reqUrl, final String reqSerial)
    {
        TimerTask task = new TimerTask()
        {
            ...
            public void run()
            {
                ...
                screen_img = ScreenImageDataCall.screenDataCall(Thumbnail_View_H.this,resBody);
            ...
            public void run() {
                ...
                try {
...

                    {
                        ...
                        beforeScreenString = beforeScreenStr;
    ...
    private void jsonrooms_data_Result(JSONObject jsonObject)
    {
        try {
            ...
            {
                Log.e("EAST", "jsonarray_rooms.length 에러");
            }
        }
        catch (Exception ex)
        {
    ...
    private void setLayoutData(final Thumbnail_sub lyt, final SharingVO data)
    {
        ...
        try
        {
            String finalHtml = WebviewScript.getMultiDataScript("h" , 50,0,0);
            ...
            Glide.with(Thumbnail_View_H.this).load(data.getProfile()).into(lyt.profile_img);
            Glide.with(Thumbnail_View_H.this).load(data.getBackImg()).dontAnimate().into(lyt.server_back_img);
    ...
    private void resetLayoutData(final Thumbnail_sub lyt, final SharingVO data)
    {
        ...
        try {
            ...
            Glide.with(Thumbnail_View_H.this).load("").into(lyt.profile_img);
            Glide.with(Thumbnail_View_H.this).load("").dontAnimate().into(lyt.server_back_img);
    ...
    private void Activity_Change()
    {
        ...
        Thumbnail_View_H.this.runOnUiThread(new Runnable()
        {
            @Override
            public void run()
            {
                ...
                if (totalRoomCnt == 0)
                {
                    ...
                    if( mainViewIndex == 0) {
                        mainView = findViewById(R.id.thumbnail_view_h_4_1);
                    }else
                    {
                        mainView = findViewById(R.id.thumbnail_view_h_4_2);
                    }
                    ...
                    ScreenImageDataCall.Screen_Glide(Thumbnail_View_H.this,screen_img,spawn_img_1);
                    ScreenImageDataCall.Screen_Glide(Thumbnail_View_H.this,screen_img,spawn_img_2);
...
//                                                        LogService.info("set i =>" + i);
                                        ...
                                        else if (oneLytRooms > 0)
                                        {
                                            ...
                                            if( mainViewIndex == 0)
                                            {
                                                mainView = findViewById(R.id.thumbnail_view_h_1_1);
                                            }
                                            else
                                            {
                                                mainView = findViewById(R.id.thumbnail_view_h_1_2);
                                            }
                                            ...
                                            //(
                                            resetLayoutData(roomLayoutManageList[1], new SharingVO());
                                            resetLayoutData(roomLayoutManageList[2], new SharingVO());
                                            resetLayoutData(roomLayoutManageList[3], new SharingVO());
                                            //)
                                        }
