...
public class Thumbnail_sub_Multi_H extends Thumbnail_sub
{




    public Thumbnail_sub_Multi_H(Context context)
    {
        super(context);
        init();
    ...
    public Thumbnail_sub_Multi_H(Context context , AttributeSet attributeSet)
    {
    ...
    protected void init()
    {
        ...
        inflater.inflate(R.layout.activity_thumbnail_item_multi_h,this,true);
