...
public class Thumbnail_sub_Split_V extends Thumbnail_sub
{




    public Thumbnail_sub_Split_V(Context context)
    {
        super(context);
        init();
    ...
    public Thumbnail_sub_Split_V(Context context , AttributeSet attributeSet)
    {
    ...
    protected void init()
    {
        ...
        inflater.inflate(R.layout.activity_thumbnail_item_split_v,this,true);
