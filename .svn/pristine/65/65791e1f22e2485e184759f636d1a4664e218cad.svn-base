...
public class Thumbnail_sub_Single_H extends Thumbnail_sub
{




    public Thumbnail_sub_Single_H(Context context)
    {
        super(context);
        init();
    ...
    public Thumbnail_sub_Single_H(Context context , AttributeSet attributeSet)
    {
    ...
    protected void init()
    {
        ...
        inflater.inflate(R.layout.activity_thumbnail_item_single_h,this,true);
