package com.nexgrid_fsp.myapplication.special.Style;
...
public class BlueFlag_sub_V extends Special_sub
{




    public BlueFlag_sub_V(Context context)
    {
        super(context);
        init();
    ...
    public BlueFlag_sub_V(Context context , AttributeSet attributeSet)
    {
    ...
    protected void init()
    {
        ...
        inflater.inflate(R.layout.activity_special_item_blueflag,this,true);
